package com.xl.actitvti.controller;

import com.xl.actitvti.util.SecurityUtil;
...
class ActivitiController {
        ...
        public void startInstance(){
            ProcessInstance instance = processRuntime.start(ProcessPayloadBuilder.start().withProcessDefinitionKey("_event").build());
